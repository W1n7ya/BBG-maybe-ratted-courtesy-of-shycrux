...
export let roomsJson = JSON.parse(FileLib.read("byebyegoldor", "data/AutoRoutes/rooms.json"))
...
request({url: "https://raw.githubusercontent.com/UnclaimedBloom6/IllegalMap/main/IllegalMap/utils/rooms.json", json: true}).then(data => {
    ...
    FileLib.write("byebyegoldor", "data/AutoRoutes/rooms.json", JSON.stringify(roomsJson, null, 4))
})
...
export const getRoomsFile = () => JSON.parse(FileLib.read("byebyegoldor", "data/AutoRoutes/rooms.json"))

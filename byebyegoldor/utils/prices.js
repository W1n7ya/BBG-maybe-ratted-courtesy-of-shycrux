...
const writeAlwaysBuy = () => {
    ...
    FileLib.write("byebyegoldor", "data/AutoCroesusData/always_buy.txt", toWrite)
}

const writeWorthless = () => {
    const toWrite = [...worthless].join("\n")
    FileLib.write("byebyegoldor", "data/AutoCroesusData/worthless.txt", toWrite)
}

export const initAlwaysBuy = () => {
    // Grab always buy and worthless items from default as they've not been initialized yet
    ChatLib.chat(`Initializing data/AutoCroesusData/always_buy.txt`)
    const defaultData = FileLib.read("byebyegoldor", "data/AutoCroesusData/defaults/always_buy.txt")
    FileLib.write("byebyegoldor", "data/AutoCroesusData/always_buy.txt", defaultData)
}

export const loadAlwaysBuy = () => {
    const alwaysBuyLines = FileLib.read("byebyegoldor", "data/AutoCroesusData/always_buy.txt").split("\n")
    alwaysBuy.clear()
...
export const initWorthless = () => {
    // Grab always buy and worthless items from default as they've not been initialized yet
    ChatLib.chat(`Initializing data/AutoCroesusData/worthless.txt`)
    const defaultData = FileLib.read("byebyegoldor", "data/AutoCroesusData/defaults/worthless.txt")
    FileLib.write("byebyegoldor", "data/AutoCroesusData/worthless.txt", defaultData)
}

export const loadWorthless = () => {
    const worthlessLines = FileLib.read("byebyegoldor", "data/AutoCroesusData/worthless.txt").split("\n")
    worthless.clear()
...
if (FileLib.exists("byebyegoldor", "data/AutoCroesusData/bzValues.json")) {
    cachedBzValues = JSON.parse(FileLib.read("byebyegoldor", "data/AutoCroesusData/bzValues.json"))
}

if (FileLib.exists("byebyegoldor", "data/AutoCroesusData/items.json")) {
    cachedItems = JSON.parse(FileLib.read("byebyegoldor", "data/AutoCroesusData/items.json"))
    itemIdMap = {}
...
if (FileLib.exists("byebyegoldor", "data/AutoCroesusData/binValues.json")) {
    cachedBins = JSON.parse(FileLib.read("byebyegoldor", "data/AutoCroesusData/binValues.json"))
}
...
const handleBzData = (resp) => {
    ...
    let data = {}
    if (FileLib.exists("byebyegoldor", "data/AutoCroesusData/bzValues.json")) {
        data = JSON.parse(FileLib.read("byebyegoldor", "data/AutoCroesusData/bzValues.json"))
    }
    ...
    cachedBzValues = data
    FileLib.write("byebyegoldor", "data/AutoCroesusData/bzValues.json", JSON.stringify(data, null, 4), true)
...
const handleItemResp = (resp) => {
    ...
    FileLib.write("byebyegoldor", "data/AutoCroesusData/items.json", JSON.stringify(resp.items, null, 4), true)
...
const handleBinResp = (resp) => {
    cachedBins = resp
    FileLib.write("byebyegoldor", "data/AutoCroesusData/binValues.json", JSON.stringify(resp, null, 4))

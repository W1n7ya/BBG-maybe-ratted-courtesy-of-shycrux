...
import { handleLootCommand, logLoot } from "../utils/lootLogs"
import { printHelp } from "../utils/help_command"
import { addAlwaysBuy, addWorthlessItem, alwaysBuy, initAlwaysBuy, initWorthless, loadAlwaysBuy, loadWorthless, updatePrices, worthless } from "../utils/prices"
import {
    acPogObj,
    appendToFile,
    CHEST_REGEX,
...
if (!FileLib.exists("byebyegoldor", "data/AutoCroesusData/always_buy.txt")) {
    initAlwaysBuy()
}
loadAlwaysBuy()

if (!FileLib.exists("byebyegoldor", "data/AutoCroesusData/worthless.txt")) {
    initWorthless()
}
loadWorthless()
